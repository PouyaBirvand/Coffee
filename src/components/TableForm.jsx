...
function TableForm() {
  const { showForm, tableNumber, setTableNumber, handleSubmit, handleCancel } =
    useTableManagement();
      ...
      {showForm && (
        <>
          <motion.div
            ...
            className="fixed inset-0 bg-black/60 z-[2998] backdrop-blur-[0.2rem]"
          />

          <div className="fixed inset-0 z-[2999] flex items-center justify-center px-10 xs:px-4">
            <motion.form
              ...
              className="relative w-[400px] xs:w-full sm:w-full md:w-[100%] bg-body rounded-[30px]"
            >
              <motion.div
                initial={{ borderWidth: 0 }}
                animate={{ borderWidth: 2 }}
                transition={{ delay: 0.2, duration: 0.3 }}
                className="border-2 border-deep-mahogany rounded-[30px] p-5 m-2"
              >
                <div className="space-y-4">
                  ...
                  <motion.h2
                    ...
                    className="text-3xl sm:text-lg md:text-2xl xs:text-base text-dark-cocoa text-center font-extrabold"
                  >
                  ...
                  >
                    ...
                    <h3 className="text-base xs:text-sm text-deep-mahogany font-normal text-center">
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.97 }}
                      type="submit"
                      className="outline-none bg-dark-cocoa flex-1 rounded-lg py-2 text-white font-semibold transition xs:text-sm"
                    >
                      Submit
                    </motion.button>
                  </motion.div>
