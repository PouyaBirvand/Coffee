...
const TableIcon = () => (
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="absolute left-3 bottom-7 -translate-y-1/2 xs:w-3 xs:h-3"
  >
    <path
...
const InfoIcon = () => (
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="flex-shrink-0 mt-1 xs:w-4 xs:h-4 relative sm:left-[1.4rem] xs:left-0"
  >
    <path
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[2999] flex items-center justify-center px-10 xs:px-4">
        ...
        >
          <div className="border-2 border-deep-mahogany rounded-[30px] p-5 m-2">
