function Products() {
  const images = [
    ...
    { src: "/assets/images/ph_coffee-light.png", alt: "Coffee", active: true },
    { src: "/assets/images/fluent_food-pizza-20-regular.png", alt: "Pizza" },
  ];

  return (
    <div
      className="mt-16 xl:mt-10 lg:mt-12 md:mt-10 sm:mt-8 xs:mt-6
                 mx-auto w-[77%] max-w-2xl xl:max-w-[18rem]  lg:max-w-lg md:max-w-md sm:max-w-sm xs:max-w-xs"
    >
      <div
        className="bg-warm-wood bg-opacity-60 rounded-full 
