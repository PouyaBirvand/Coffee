function Products() {
  return (
    <div className="flex justify-between items-center shadow-md mt-[3.2rem] bg-warm-wood bg-opacity-60 rounded-[50rem] py-1 px-3 mx-auto w-[65%] md:w-[75%] max-w-md overflow-scroll gap-[0.5rem]">
      <img
        src="/assets/images/ph_ice-cream-light.png"
        alt="iceCream"
        className="hover:bg-deep-mahogany bg-soft-cream  p-2 rounded-full transition duration-300 cursor-pointer bg-opacity-50"
      />
      <img
