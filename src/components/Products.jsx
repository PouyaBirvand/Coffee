function Products() {
  return (
    <div className="flex justify-between items-center shadow-md mt-[3.2rem] bg-warm-wood bg-opacity-60 rounded-[50rem] py-1 px-3 mx-auto w-[68%] md:w-[75%] max-w-md overflow-scroll gap-[0.5rem]">
      <img
