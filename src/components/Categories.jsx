...
function Categories({ onCategoryChange, selectedCategory }) {
  ...
  return (
    <div className="className= xl:mt-10 lg:mt-12 md:mt-10 sm:mt-8 xs:mt-5 mx-auto w-[78%] max-w-2xl xl:max-w-[19.5rem] lg:max-w-lg md:max-w-md sm:max-w-sm xs:max-w-xs">
