...
function ProductTitle({isExpanded}) {
  return (
    <div className="relative text-center mt-3 h-[3rem]">
      <h1 className={`inline-block font-extrabold text-deep-mahogany px-4 leading-[2rem] relative text-[2.6rem] sm:w-40 lg:text-[2rem] ${isExpanded && 'lg:text-[3.5rem] text-[4rem] leading-[4rem] mt-1 md:!text-[2.9rem]'}`}>
