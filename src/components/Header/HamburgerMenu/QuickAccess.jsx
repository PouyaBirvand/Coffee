...
const CATEGORY_ICONS = {
  ...
  6: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24}  fill={"none"} color="currentColor">
...
const QuickAccess = ({ closeMenu }) => {
  ...
  const { activeItem, handleItemClick } = useCategoryNavigation(categories, closeMenu);
