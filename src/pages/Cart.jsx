        ...
        {cart.length === 0 ? (
          ...
          <>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="-mt-[1.5rem] w-[92%] mx-auto sm:mt-[1rem] h-[29rem] overflow-scroll relative z-[1]"
            >
              <AnimatePresence>
                {cart?.map((item) => (
                  <motion.div
                      ...
                      <div className="flex items-center justify-between pb-1">
                        <div className="flex items-center">
                          ...
                          <motion.span
                            ...
                            initial={{ scale: 0.8 }}
                            animate={{ scale: 1 }}
                            className="text-dark-cocoa px-3 py-1 font-extrabold"
                          >
                            {item.quantity || 1}
                          </motion.span>
                          <motion.button
            ...
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="fixed bottom-[6rem] left-0 right-0 bg-translucent-coffee bg-opacity-40 shadow-md p-4 rounded-2xl mx-auto w-[80%] z-[1] sm:bottom-[5.5rem]"
            >
