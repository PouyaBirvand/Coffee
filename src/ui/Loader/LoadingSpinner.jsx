export function LoadingSpinner() {
    return (
      <div className="mt-[2.5rem] w-[95%] md:w-[80%] lg:w-[80%] mx-auto min-h-[300px] bg-warm-wood bg-opacity-20 rounded-2xl flex flex-col items-center justify-center gap-4">
